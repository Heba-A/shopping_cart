...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/add_to_')) {
            // app_default_add_to_cart
            if (0 === strpos($pathinfo, '/add_to_cart') && preg_match('#^/add_to_cart/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_default_add_to_cart')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::add_to_cart',));
            }
